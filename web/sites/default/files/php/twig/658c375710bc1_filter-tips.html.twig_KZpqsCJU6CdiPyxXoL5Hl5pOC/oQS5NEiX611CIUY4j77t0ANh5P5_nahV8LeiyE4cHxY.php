...
class __TwigTemplate_e6abcd0773bad6610f9827228281b1b5 extends Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-tips__item--id-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 50), 50, $this->source)))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/claro/templates/filter/filter-tips.html.twig", "/Users/zubair/Library/Mobile Documents/com~apple~CloudDocs/Desktop/drupal/web/core/themes/claro/templates/filter/filter-tips.html.twig");
    }
