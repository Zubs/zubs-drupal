...
class __TwigTemplate_f02d8668fe2702ba2f60f81c164ffdb8 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        if (($context["items"] ?? null)) {
            ...
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", ["media-library-add-form__added-media"], "method", false, false, true, 30), 30, $this->source), "html", null, true);
            echo ">";
            // line 31
        ...
        $this->env->getExtension('\Drupal\Core\Template\TwigExtension')
            ->checkDeprecations($context, ["items", "title", "list_type", "attributes"]);    }
    ...
    {
        return new Source("", "core/themes/claro/templates/media-library/item-list--media-library-add-form-media-list.html.twig", "/Users/zubair/Library/Mobile Documents/com~apple~CloudDocs/Desktop/drupal/web/core/themes/claro/templates/media-library/item-list--media-library-add-form-media-list.html.twig");
    }
