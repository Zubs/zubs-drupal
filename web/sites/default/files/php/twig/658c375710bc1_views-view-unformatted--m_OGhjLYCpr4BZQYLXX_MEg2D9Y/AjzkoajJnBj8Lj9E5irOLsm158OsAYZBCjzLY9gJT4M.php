...
class __TwigTemplate_f3fc6c73e87113de940a08154d3dfed6 extends Template
{
    private $source;
    private $macros = [];
...
($context["default_row_class"] ?? null)) ? ("views-row") : ("")), "media-library-item", "media-library-item--grid"];
            // line 30
            echo "    <div";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["row"], "attributes", [], "any", false, false, true, 30), "addClass", [($context["row_classes"] ?? null)], "method", false, false, true, 30), 30, $this->source), "html", null, true);
            echo ">";
            // line 31
...
";
    ...
    {
        return new Source("", "core/themes/claro/templates/media-library/views-view-unformatted--media-library.html.twig", "/Users/zubair/Library/Mobile Documents/com~apple~CloudDocs/Desktop/drupal/web/core/themes/claro/templates/media-library/views-view-unformatted--media-library.html.twig");
    }
